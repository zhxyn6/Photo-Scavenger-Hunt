...
class HuntDetailViewController: UIViewController {
    ...
    private func updateUI() {
        ...
        let image = UIImage(systemName: hunt.isComplete ? "circle.inset.filled": "circle")
...
extension HuntDetailViewController: PHPickerViewControllerDelegate {
    ...
    func picker(_ picker: PHPickerViewController, didFinishPicking results: [PHPickerResult]) {
        ...
        //TODO: Get the image from the chosen photo
        ...
        provider.loadObject(ofClass: UIImage.self) { [weak self] object, error in
            ...
            /// since we're updating the image property on our Task model, the computed var isComplete will now return true for the given task
